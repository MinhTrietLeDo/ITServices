    ...
    if (typeof userInfo[0].data !== 'undefined') {
      let userProfile = userInfo[0].data.map(arr => {
        ...
        if (rLocation === null) {
          ...
          setUserLocation(rLocation);
        }
        if (email === null) {
          setUserEmail('Chưa cập nhật');
        } else {
          setUserEmail(email);
        }
        if (phoneNumber === null) {
          setUserPhone('Chưa cập nhật');
        } else {
          setUserPhone(phoneNumber);
        }
        if (createDate === null) {
          setUserCreateDate('Chưa cập nhật');
        } else {
          setUserCreateDate(createDate);
        }
        if (lastLogin === null) {
          setUserLastLogin('Chưa cập nhật');
        } else {
